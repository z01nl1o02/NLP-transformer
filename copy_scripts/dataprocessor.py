...
import copy_scripts._constants as _constants
import copy_scripts.dataset as _dataset
...
def make_dataloader(data_train, data_val, data_test, args,
    ...
    train_batchify_fn = btf.Tuple(btf.Pad(pad_val=cfg.pad_val), btf.Pad(pad_val=cfg.pad_val),
                                  btf.Stack(dtype='float32'), btf.Stack(dtype='float32'))
    test_batchify_fn = btf.Tuple(btf.Pad(pad_val=cfg.pad_val), btf.Pad(pad_val=cfg.pad_val),
                                 btf.Stack(dtype='float32'), btf.Stack(dtype='float32'),
                                 btf.Stack())
